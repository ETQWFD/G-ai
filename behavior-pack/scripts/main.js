/**
 * G-ai v1.6.1 —— 行为包内置 AI 分身脚本（基岩版 / 网易中国版兼容）
 *
 * 关键修复：
...
world.sendMessage("§7[G-ai] §f脚本已加载 v1.6.1：进世界自动创建 AI 玩家；也可用 §e/scriptevent gai:spawn §f创建、§e/scriptevent gai:chat 内容§f对话、§e/function gai_summon §f触发；聊天框输入 §e@AI 内容§f即可对话干活（支持 @ai、ai:、/ai 多种写法；若网络不可用将自动离线应答）。");
